...
1. Attachment Management Plugin: For automatic folder creation & nesting under `_assets` depending on where you pasted images. ![Auto organized attachments showcase](_assets/images/README/IMG-20260206163250296.png)
2. Excalidraw (kind of WIP): For drawings, Helping with Flow diagrams and embedding right into your notes ![Excalidraw Showcase](_assets/images/README/IMG-20260206164013920.png)
3. Image Toolkit: Better viewing experience for images with scroll to zoom, full-screen, copy etc. Baked right into the edit view. ![Refined Image viewer showcase](_assets/images/README/IMG-20260206165129843.png)
